# PLAN STATUS: 🟢 NEARLY COMPLETE - All major features implemented. History view remains.

# Hybr### 9. UI Updates

- [x] Default: show only `status == active`. ✅ IMPLEMENTED
- [x] Add views for done/archived/deleted items. ✅ IMPLEMENTED (via kebab menu and modals)
- [x] "Undo/Restore" functionality for cards and lists. ✅ IMPLEMENTED
- [ ] **REMAINING**: Card/task history view → fetch subcollection.
...
3. **UI Features**: Add history view, restore functionality, and status filter togglesestore Data Strategy — Implementation Checklist
