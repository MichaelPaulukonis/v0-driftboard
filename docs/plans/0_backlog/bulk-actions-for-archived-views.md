# Feature: Bulk Actions in Archived Views
...
**Use Case:**
Improves efficiency when managing large numbers of non-active cards, such as cleaning up old "Done" items at the end of a project.
